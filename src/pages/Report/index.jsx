...
const baseURL = "https://miracle49-001-site1.itempurl.com/api/testing/reports/tickets?SystemDate=2023-09-03";
...
const index = () => {
 ...
 const handelPrint =useReactToPrint({
  ...
  return (
    ...
    <div ref={componentRef} className={`shadow p-3 mb-5 bg-body rounded ${styles.root}`}>
      ...
      <button onClick={handelPrint} type="button" className="btn btn-outline-primary">Print</button>
    </div>
  )
}
